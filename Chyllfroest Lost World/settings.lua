...
settings.itemsToBuy = {
    ...
    { name = "Great Mana Potion",      id = 238,   vocation = { "paladin", "sorcerer", "druid" },           amount = 350, type = 'potions' },
...
-- Check to refill
settings.MinCapacityConfig = 250 -- Quantidade mínima de CAP para continuar a hunt
...
settings.refillItems = {
    ...
    { name = "Great Mana Potion",      id = 238,   minQuantity = 50,  check = true },
    ...
    { name = "Avalanche Rune",         id = 3161,  minQuantity = 200, check = true },
