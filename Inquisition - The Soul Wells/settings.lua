...
settings.itemsToBuy = {
    ...
    { name = "Ultimate Health Potion", id = 7643,  vocation = { "knight" },                                 amount = 300,  type = 'potions' },
    ...
    { name = "Strong Mana Potion",     id = 237,   vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 3600, type = 'potions' },
    -- SPIRIT
