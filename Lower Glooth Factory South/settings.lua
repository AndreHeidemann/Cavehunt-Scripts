...
settings.itemsToBuy = {
    ...
    -- MANA
    -- { name = "Ultimate Mana Potion",  id = 23373, vocation = { "sorcerer", "druid" },                      amount = 600, type = 'potions' },
    -- { name = "Great Mana Potion",      id = 238,   vocation = { "paladin", "sorcerer", "druid" },           amount = 1500, type = 'potions' },
    { name = "Strong Mana Potion",     id = 237,   vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 3000, type = 'potions' },
    -- SPIRIT
    -- { name = "Ultimate spirit Potion", id = 23374, vocation = { "paladin" },                                amount = 400,  type = 'potions' },
    ...
    -- { name = "ThunderStorm Rune",     id = 3202,  vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 900, type = 'runes' },
...
-- Check to refill
settings.MinCapacityConfig = 400 -- Quantidade mínima de CAP para continuar a hunt
...
settings.refillItems = {
    ...
    -- MANA
    -- { name = "Ultimate Mana Potion",  id = 23373, minQuantity = 70,  check = true },
    -- { name = "Great Mana Potion",      id = 238,   minQuantity = 0, check = true },
    { name = "Strong Mana Potion",     id = 237,   minQuantity = 400, check = true },
    -- SPIRIT
    ...
    -- { name = "ThunderStorm Rune",     id = 3202,  minQuantity = 100, check = true },
    ...
    -- DISTANCE
    -- { name = "Diamond Arrow",          id = 35901, minQuantity = 0, check = true },
