...
settings.itemsToBuy = {
    -- HP
    { name = "Supreme Health Potion",  id = 23375, vocation = { "knight" },                                 amount = 100,  type = 'potions' },
    ...
    { name = "Strong Mana Potion",     id = 237,   vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 1900, type = 'potions' },
    -- SPIRIT
...
-- Check to refill
settings.MinCapacityConfig = 600 -- Quantidade mínima de CAP para continuar a hunt
