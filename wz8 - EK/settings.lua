...
settings.itemsToBuy = {
    -- HP
    { name = "Supreme Health Potion",  id = 23375, vocation = { "knight" },                                 amount = 250,  type = 'potions' },
    ...
    { name = "Strong Mana Potion",     id = 237,   vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 750, type = 'potions' },
    -- SPIRIT
...
settings.refillItems = {
    ...
    { name = "Ultimate Health Potion", id = 7643,  minQuantity = 150,  check = true },
    ...
    { name = "Strong Mana Potion",     id = 237,   minQuantity = 350, check = true },
    -- SPIRIT
