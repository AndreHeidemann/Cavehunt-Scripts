...
settings.itemsToBuy = {
    ...
    { name = "Ultimate Health Potion", id = 7643,  vocation = { "knight" },                                 amount = 1400, type = 'potions' },
    ...
    -- { name = "Great Mana Potion",      id = 238,   vocation = { "paladin", "sorcerer", "druid" },           amount = 1800, type = 'potions' },
...
settings.refillItems = {
    -- HP
    { name = "Supreme Health Potion",  id = 23375, minQuantity = 60,  check = true },
    ...
    { name = "Strong Mana Potion",     id = 237,   minQuantity = 500, check = true },
    -- SPIRIT
