...
settings.itemsToBuy = {
    ...
    -- SPIRIT
    { name = "Ultimate spirit Potion", id = 23374, vocation = { "paladin" },                                amount = 500,  type = 'potions' },
    ...
    { name = "Avalanche Rune",         id = 3161,  vocation = { "knight", "paladin", "sorcerer", "druid" }, amount = 1200, type = 'runes' },
...
settings.distanceToBuy = {
    -- DISTANCE
    { name = "Diamond Arrow",     amount = 2000, id = 35901, vocation = { "paladin" }, type = 'distance' },
...
settings.refillItems = {
    -- HP
    { name = "Supreme Health Potion",  id = 23375, minQuantity = 50,  check = false },
    { name = "Ultimate Health Potion", id = 7643,  minQuantity = 100, check = false },
    ...
    { name = "Great Mana Potion",      id = 238,   minQuantity = 300, check = true },
